...
class AddgeneTest(unittest.TestCase):
    def test_request_plasmid(self):
        ...
        examples = [
            {
                'id': '39282',
                'url': 'https://www.addgene.org/browse/sequences/240599/4936a6ae-6b4d-4d24-b7ac-2339fad5755d/addgene-plasmid-39282-sequence-240599.gbk',
                'type': 'addgene-full',
                'name': 'pFA6a-kanMX6-P81nmt1',
            },
            {
                'id': '39289',
                'url': 'https://www.addgene.org/browse/sequences/49640/4fa9f18b-d5ca-4ac6-a50c-76a6cd15cbab/addgene-plasmid-39289-sequence-49640.gbk',
                'type': 'depositor-full',
